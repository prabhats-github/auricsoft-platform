...
<head>
    ...
    <!-- metas -->
    <meta charset="utf-8">
    <meta name="author" content="Auricsoft Platform">
    ...
    <!-- title  -->
    <title>Auricsoft Platform - Software Product Development Company</title> 
    ...
    <div class="main-wrapper">
        ...
        <section class="py-0 top-position1 banner-style01">
            <div class="slider-fade1 owl-carousel owl-theme w-100">
                <div class="item bg-img cover-background full-screen secondary-overlay" data-overlay-dark="7" data-background="img/banner/software-development-company-min.jpg">
                ...
                <div class="item bg-img cover-background full-screen secondary-overlay" data-overlay-dark="7" data-background="img/banner/blockchain-min.png">
                    <div class="container position-relative z-index-9">
                        <div class="row align-items-center min-vh-100 text-center justify-content-center">
                            <div class="col-lg-8">
                                <div class="mt-5 mt-sm-0">
                ...
                <div class="item bg-img cover-background full-screen secondary-overlay" data-overlay-dark="7" data-background="img/banner/ai-development.png">
                    <div class="container position-relative z-index-9">
                        <div class="row align-items-center min-vh-100 text-center justify-content-center">
                            <div class="col-lg-8">
                                <div class="mt-5 mt-sm-0">
        ...
        <section class="bg-light">
            <div class="container position-relative z-index-9">
                <div class="section-title mb-1-9 mb-md-6 text-center">
                    ...
                    <h2 class="mb-0 h1">Services That Help You Grow.</h2>
                </div>                
                <div class="row g-xl-5 mt-n1-6">
                    <div class="col-md-6 col-xl-4 mt-1-6">
                        <div class="card-style03 bg-img cover-background overflow-visible bg-light" data-background="img/service/webdesunsplash.jpg">
                            <span class="icon">
                    ...
                    <div class="col-md-6 col-xl-4 mt-1-6">
                        <div class="card-style03 bg-img cover-background overflow-visible bg-light" data-background="img/service/service_02.jpg">
                            <span class="icon">
                    ...
                    <div class="col-md-6 col-xl-4 mt-1-6">
                        <div class="card-style03 bg-img cover-background overflow-visible bg-light" data-background="img/service/service_03.jpg">
                            <span class="icon">
                                ...
                                <div class="row">
                                    <div class="col-6 wow fadeInDown" data-wow-delay="200ms">
                                        <div class="image-hover position-relative overflow-hidden">
                                            <img src="img/content/about-05.jpg" alt="..." class="rounded">
                                        </div>
                                    </div>
                                    <div class="col-6 wow fadeInUp" data-wow-delay="400ms">
                                        <div class="image-hover position-relative overflow-hidden">
                                            <img src="img/content/about_04.jpg" alt="..." class="mt-1-9 mt-sm-10 rounded">
                                        </div>
                                    </div>
                                </div>
                                <div class="sm-box-wrapper z-index-9 wow fadeIn" data-wow-delay="600ms">
                                    <div class="inner-box">
                                        <span class="exp-no">18</span>
                            ...
                            <div class="ps-1-9 ps-xl-11">
                                <div class="about-content">
                                    <div class="section-title mb-1-9">
                                        <span class="sm-title">Who We Are</span>
                                        <h2 class="mb-0 h1">We offer the best design and development services!</h2>
                                    </div>
                                    <!-- <p>Our objective is to offer a high-quality service and a dependable source of income to our investors while simultaneously minimizing any potential risks and automating and simplifying the relationships.</p> -->
                                    <p>Our aim to achieve, such as increasing sales, boosting brand awareness, and building customer loyalty.</p>
                                    <div class="about-list">
                                        <!-- <div class="about-author wow fadeIn" data-wow-delay="200ms">
                                            <img src="img/content/signature-2.png" alt="...">
                                            <h4 class="display-28 mt-2">Mita Walker</h4>
                                            <span class="display-31">CEO, Flyweb</span>
                                        ...
                                        <div class="about-list">
                                            <ul class="list-unstyled mb-0">
                                                <li class="wow fadeInUp" data-wow-delay="200ms"><i class="fas fa-check"></i> Provide Web Design &amp; Development</li>
                                                <li class="wow fadeInUp" data-wow-delay="300ms"><i class="fas fa-check"></i> We Provide Logo Design &amp; Copywriting</li>
                                                <li class="wow fadeInUp" data-wow-delay="400ms"><i class="fas fa-check"></i> Best Website Support &amp; Consultations</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- EXTRA
        ================================================== -->
        <section class="exrta-section item bg-img cover-background secondary-overlay" data-overlay-dark="8" data-background="img/bg/bg-01.jpg">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-9 col-lg-8">
                        <div class="section-title text-center mb-1-9 wow fadeIn" data-wow-delay="200ms">
                            <span class="sm-title">Who We Are</span>
                            <h2 class="text-white h1">Web solutions allows your business to increase productivity</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div id="accordion" class="accordion-style">
                                <div class="card mb-3 wow fadeInUp" data-wow-delay="100ms">
                                    ...
                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                        <div class="card-body">
                                            Great companies form a community around their employees, with a common vision and support for everyone's goals.                                        </div>
                                    </div>
                                </div>
                                <div class="card mb-3 wow fadeInUp" data-wow-delay="200ms">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordion">
                                        <div class="card-body">
                                            A business process is defined as a series of tasks or a set of activities performed by a group of stakeholders to achieve an organizational goal.                                        </div>
                                    </div>
                                </div>
                                <div class="card wow fadeInUp" data-wow-delay="300ms">
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordion">
                                        <div class="card-body">
                                            One of the better ways to use your personal business card is to give it out while asking someone to stay in touch after your first acquaintance.                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="faq-img d-none d-lg-block">
                            ...
                            <div class="faq-video story-video">
                                <a href="https://www.youtube.com/watch?v=fS4cH2fky5M" class="video-btn video" data-type="iframe" tabindex="0">
                    ...
                    <div class="col-lg-6 mt-1-9 position-relative">
                        <div class="position-relative pe-lg-1-9 row align-items-center">
                            <div class="col-5 image-hover">
                                <img src="img/content/why-choose-02.jpg" alt="" class="rounded">
                            </div>
                            <div class="col-7 image-hover">
                                <img src="img/content/why-choose-01.jpg" alt="" class="rounded">
                            </div>
                            <div class="about2-yearbox d-none d-sm-block rounded">
                                <p class="lead mb-0">We’re delivering the best customer experience!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mt-1-9">
                        <div class="ps-4 ps-xl-2-9">
                            <div class="section-title wow fadeInUp" data-wow-delay="100ms">
                                ...
                                <h2 class="h1 mb-1-9">We are award winning web development agency.</h2>
                            </div>              
                            <div class="d-sm-flex align-items-center mb-2-9">
                                <div>
                                    <ul class="list-style2 mb-0">
                                        <li class="wow fadeInUp" data-wow-delay="200ms">Remarkable to receive such a personalized touch.</li>
                                        <li class="wow fadeInUp" data-wow-delay="300ms">Innovative solutions driven by expert excellence.</li>
                                        <li class="wow fadeInUp" data-wow-delay="400ms">Transforming ideas into success with expertise.</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="d-sm-flex align-items-center thumb-image">
                                <div class="flex-shrink-0 mb-4 mb-sm-0">
                                    <img src="img/avatars/avatar-01.jpg" class="w-55px rounded-circle wow fadeInRight" data-wow-delay="100ms" alt="...">
                                    <img src="img/avatars/avatar-02.jpg" class="w-55px rounded-circle img1 wow fadeInRight" data-wow-delay="200ms" alt="...">
                                    <img src="img/avatars/avatar-03.jpg" class="w-55px rounded-circle img2 wow fadeInRight" data-wow-delay="300ms" alt="...">
                ...
                <div class="main-process text-center">
                    ...
                    <div class="row mt-n6">
                        <div class="process-style-01 process-style-02 col-lg-4 col-md-6 mt-6 wow fadeInUp" data-wow-delay="200ms">
                            <div class="item">
                                <div class="thumb">
                                    <img src="img/content/process_001.jpg" alt="...">
                                    <span>01</span>
                                </div>
                                <h5 class="text-white">Design</h5>
                                <p class="w-lg-80 mx-auto mb-0 text-white">"Develop strategic solutions to fuel business success."</p>
                            </div>
                        </div>
                        ...
                        <div class="process-style-01 col-lg-4 col-md-6 mt-6 wow fadeInUp" data-wow-delay="300ms">
                            <div class="item">
                                <div class="thumb">
                                    <img src="img/content/process_02.jpg" alt="...">
                                    <span>02</span>
                                </div>
                                <h5 class="text-white">Strategy</h5>
                                <p class="w-lg-80 mx-auto mb-0 text-white">"Maximize growth by innovating and prioritizing customer needs."</p>
                            </div>
                        </div>
                        ...
                        <div class="process-style-01 col-lg-4 col-md-6 mt-6 wow fadeInUp" data-wow-delay="400ms">
                            <div class="item">
                                ...
                                <p class="w-lg-80 mx-auto mb-0 text-white">"Develop cutting-edge solutions to enhance business performance."</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <img src="img/content/about3.png" class="position-absolute bottom-0 left" alt="...">
        </section>

        <!-- TESTIMONIAL
        ================================================== -->
        <section class="bg-light bg-img cover-background" data-background="img/bg/bg-05.png">
            <div class="container">
                <div class="section-title mb-1-9 mb-md-6 text-center wow fadeIn" data-wow-delay="200ms">
                    <span class="sm-title">Our Testimonials</span>
                    <h2 class="mb-0 h1">What They're Saying?</h2>
                </div>
                <div class="row gx-xxl-5 mt-n2-9">
                        ...
                        <div class="testimonial-style1">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-4 pt-4">
                                    <h4 class="h5 mb-1">Zachary Holden</h4>
                                    <small>CEO & Founder</small>
                                </div>
                            </div>
                            <div class="testi-text">
                                <i class="fa-solid fa-quote-right icon"></i>
                                <div class="item-desc">We've used web design agency for the last five years. We can't understand how we've been living without web design agency. Thank You!</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mt-2-9 wow fadeIn" data-wow-delay="350ms">
                        <div class="testimonial-style1">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-4 pt-4">
                                    <h4 class="h5 mb-1">Daniel Johann</h4>
                                    <small>Satisfied customers</small>
                                </div>
                            </div>
                            <div class="testi-text">
                                <i class="fa-solid fa-quote-right icon"></i>
                                <div class="item-desc">I am so pleased with this product. Absolutely wonderful! You won't regret it. It's really wonderful. Definitely worth the investment.</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mt-2-9 wow fadeIn" data-wow-delay="500ms">
                        <div class="testimonial-style1">
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <img src="img/avatars/avatar-07.jpg" class="border-radius-10" alt="...">
                                </div>
                                <div class="flex-grow-1 ms-4 pt-4">
                                    <h4 class="h5 mb-1">Alannah Jeffcott</h4>
                                    <small>Business Consultant</small>
                                </div>
                            </div>
                            <div class="testi-text">
                                <i class="fa-solid fa-quote-right icon"></i>
                                <div class="item-desc">I'd be lost without web design agency. Web design agency is the most valuable business resource we have EVER purchased.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="position-relative z-index-2">
                <div class="scrolling-text scrolling-left-text">
                    <div class="scrolling-marquee">
                        <h4 class="ms-2 display-1 font-weight-800"> Design & Branding — Web Development — Product Design — </h4>
                        <h4 class="ms-2 display-1 font-weight-800 ms-2"> Mobile Application — Web Application — SEO Optimization - </h4>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <div class="section-title mb-1-9 mb-md-6 text-center wow fadeIn" data-wow-delay="200ms" >
                    ...
                    <h2 class="mb-0 h1">Our Recent News</h2>
                </div>
                <div class="row g-xl-5 mt-n2-2">
                    <div class="col-md-6 col-lg-4 mt-2-2 wow fadeInUp" data-wow-delay="200ms">
                        <article class="card card-style04 h-100">
                            <div class="blog-img position-relative overflow-hidden image-hover">
                                <img src="img/blog/blog-01.jpg" alt="..." class="rounded-top">
                                <div class="card-list">
                                    <a href="#!">Solutions</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 mt-2-2 wow fadeInUp" data-wow-delay="300ms">
                        <article class="card card-style04 h-100">
                            <div class="blog-img position-relative overflow-hidden image-hover">
                                <img src="img/blog/blog-02.jpg" alt="..." class="rounded-top">
                                <div class="card-list">
                                    <a href="#!">Marketing</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4 mt-2-2 wow fadeInUp" data-wow-delay="400ms">
                        <article class="card card-style04 h-100" >
                            <div class="blog-img position-relative overflow-hidden image-hover">
                                <img src="img/blog/blog-03.jpg" alt="..." class="rounded-top">
                                <div class="card-list">
