...
<head>
    ...
    <!-- title  -->
    <title>Auricsoft Platform - Contact Page</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <!-- PAGE TITLE
        ================================================== -->
        <section class="page-title-section top-position1 bg-img cover-background left-overlay-secondary" data-overlay-dark="7" data-background="img/banner/contact21.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="contact-us">
                    <div class="row mt-n2-9">
                        <div class="col-lg-7 mt-2-9">
                            ...
                            <form class="contact quform" action="https://flywebhtml.websitelayout.net/quform/contact.php" method="post" enctype="multipart/form-data" onclick="">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="contact-info">
                                            ...
                                            <div class="contacts-title">
                                                ...
                                                <h6 class="text-white font-weight-400">info@auricsoft.com</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="contact-info">
                                            ...
                                            <div class="contacts-title">
                                                ...
                                                <h6 class="text-white font-weight-400">+91 8650155151</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="contact-info upper2">
                                            ...
                                            <div class="contacts-title">
                                                ...
                                                <h6 class="text-white font-weight-400">E 44/3, Pocket D, Okhla Phase II, Okhla Industrial Area, New Delhi</h6>
                                                <h6 class="text-white font-weight-400">1st Floor, 199, Saket, Opp Nehru Stadium, Roorkee - 247667</h6>
                                                
                                            </div>
                                        </div>
                                    </div>
                                    <div class="follow-company-icon2">
                                        <a href="https://www.facebook.com/auricsoft06"> <i class="fab fa-facebook-f"></i> </a>
                                        <a href="https://x.com/i/flow/login?redirect_after_login=%2Fauricsoft06"> <i class="fab fa-twitter"> </i> </a>
                                        <a href="https://www.linkedin.com/company/auricsoft06"> <i class="fab fa-linkedin-in"></i> </a>
                                        <!-- <a href=""> <i class="fab fa-pinterest-p"></i> </a> -->
                                        <a href="https://www.instagram.com/auricsoft06/"> <i class="fa-brands fa-instagram"></i> </a>
        ...
        <section class="p-0">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d13838.756981179791!2d77.8850982!3d29.8732346!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb3aa259e076f%3A0x3473b0f926774ff!2sAuricsoft%20Platform%20%7C%20Software%20%26%20Mobile%20Apps%20Development%20Company%20in%20Roorkee!5e0!3m2!1sen!2sin!4v1726049670772!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </section>
